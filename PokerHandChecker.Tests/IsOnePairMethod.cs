...
[TestClass]
public sealed class IsOnePairMethod
{
    ...
    public void TestOnHandWithNoCards()
    {
        ...
        var expected = false;
        var actual = sut.IsOnePair(handWithNoCards);
    ...
    public void TestOnHandWithFourDifferentCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsOnePair(handWithFiveDifferentCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfFiveCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsOnePair(handWithTwoEqualOfFiveCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithSixDifferentCards()
    {
        ...
        var expected = false;
        var actual = sut.IsOnePair(handWithSixDifferentCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualCards()
    {
        ...
        var expected = false;
        var actual = sut.IsOnePair(handWithTwoEqualCard);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithFiveEqualCards()
    {
        ...
        var expected = false;
        var actual = sut.IsOnePair(handWithFiveEqualCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualPairOfCards()
    {
        ...
        var expected = false;
        var actual = sut.IsOnePair(handWithTwoEqualPairOfCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfFourCards()
    {
        ...
        var expected = false;
        var actual = sut.IsOnePair(handWithTwoEqualOfFourCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfSixCardsWithDifferentFaces()
    {
        ...
        var expected = false;
        var actual = sut.IsOnePair(handWithTwoEqualOfSixCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfSixCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsOnePair(handWithTwoEqualOfSixCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
