...
[TestClass]
public sealed class IsThreeOfAKindMethod
{
    ...
    public void TestOnHandWithNoCards()
    {
        ...
        var expected = false;
        var actual = sut.IsThreeOfAKind(handWithNoCards);
    ...
    public void TestOnHandWithFourDifferentCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsThreeOfAKind(handWithFiveDifferentCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfFiveCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsThreeOfAKind(handWithTwoEqualOfFiveCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithSixDifferentCards()
    {
        ...
        var expected = false;
        var actual = sut.IsThreeOfAKind(handWithSixDifferentCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualCards()
    {
        ...
        var expected = false;
        var actual = sut.IsThreeOfAKind(handWithTwoEqualCard);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithFiveEqualCards()
    {
        ...
        var expected = false;
        var actual = sut.IsThreeOfAKind(handWithFiveEqualCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualPairOfCards()
    {
        ...
        var expected = false;
        var actual = sut.IsThreeOfAKind(handWithTwoEqualPairOfCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfFourCards()
    {
        ...
        var expected = false;
        var actual = sut.IsThreeOfAKind(handWithTwoEqualOfFourCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfSixCardsWithDifferentFaces()
    {
        ...
        var expected = false;
        var actual = sut.IsThreeOfAKind(handWithTwoEqualOfSixCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfSixCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsThreeOfAKind(handWithTwoEqualOfSixCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
