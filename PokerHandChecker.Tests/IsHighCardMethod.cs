...
[TestClass]
public sealed class IsHighCardMethod
{
    ...
    public void TestOnHandWithNoCards()
    {
        ...
        var expected = false;
        var actual = sut.IsHighCard(handWithNoCards);
    ...
    public void TestOnHandWithFourDifferentCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsHighCard(handWithFiveDifferentCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfFiveCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsHighCard(handWithTwoEqualOfFiveCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithSixDifferentCards()
    {
        ...
        var expected = false;
        var actual = sut.IsHighCard(handWithSixDifferentCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualCards()
    {
        ...
        var expected = false;
        var actual = sut.IsHighCard(handWithTwoEqualCard);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithFiveEqualCards()
    {
        ...
        var expected = false;
        var actual = sut.IsHighCard(handWithFiveEqualCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualPairOfCards()
    {
        ...
        var expected = false;
        var actual = sut.IsHighCard(handWithTwoEqualPairOfCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfFourCards()
    {
        ...
        var expected = false;
        var actual = sut.IsHighCard(handWithTwoEqualOfFourCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfSixCardsWithDifferentFaces()
    {
        ...
        var expected = false;
        var actual = sut.IsHighCard(handWithTwoEqualOfSixCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfSixCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsHighCard(handWithTwoEqualOfSixCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
