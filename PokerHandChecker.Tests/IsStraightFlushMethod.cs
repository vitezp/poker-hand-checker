...
[TestClass]
public sealed class IsStraightFlushMethod
{
    ...
    public void TestOnHandWithNoCards()
    {
        ...
        var expected = false;
        var actual = sut.IsStraightFlush(handWithNoCards);
    ...
    public void TestOnHandWithFourDifferentCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsStraightFlush(handWithFiveDifferentCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithHighCard_1()
    {
        ...
        var expected = false;
        var actual = sut.IsStraightFlush(handWithTwoEqualOfSixCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfFiveCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsStraightFlush(handWithTwoEqualOfFiveCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithSixDifferentCards()
    {
        ...
        var expected = false;
        var actual = sut.IsStraightFlush(handWithSixDifferentCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualCards()
    {
        ...
        var expected = false;
        var actual = sut.IsStraightFlush(handWithTwoEqualCard);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithFiveEqualCards()
    {
        ...
        var expected = false;
        var actual = sut.IsStraightFlush(handWithFiveEqualCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualPairOfCards()
    {
        ...
        var expected = false;
        var actual = sut.IsStraightFlush(handWithTwoEqualPairOfCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfFourCards()
    {
        ...
        var expected = false;
        var actual = sut.IsStraightFlush(handWithTwoEqualOfFourCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfSixCardsWithDifferentFaces()
    {
        ...
        var expected = false;
        var actual = sut.IsStraightFlush(handWithTwoEqualOfSixCards);
        Assert.AreEqual(expected, actual);
    }
