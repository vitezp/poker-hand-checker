...
[TestClass]
public sealed class IsTwoPairMethod
{
    ...
    public void TestOnHandWithNoCards()
    {
        ...
        var expected = false;
        var actual = sut.IsTwoPair(handWithNoCards);
    ...
    public void TestOnHandWithFourDifferentCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsTwoPair(handWithFiveDifferentCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfFiveCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsTwoPair(handWithTwoEqualOfFiveCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithSixDifferentCards()
    {
        ...
        var expected = false;
        var actual = sut.IsTwoPair(handWithSixDifferentCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualCards()
    {
        ...
        var expected = false;
        var actual = sut.IsTwoPair(handWithTwoEqualCard);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithFiveEqualCards()
    {
        ...
        var expected = false;
        var actual = sut.IsTwoPair(handWithFiveEqualCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualPairOfCards()
    {
        ...
        var expected = false;
        var actual = sut.IsTwoPair(handWithTwoEqualPairOfCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfFourCards()
    {
        ...
        var expected = false;
        var actual = sut.IsTwoPair(handWithTwoEqualOfFourCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfSixCardsWithDifferentFaces()
    {
        ...
        var expected = false;
        var actual = sut.IsTwoPair(handWithTwoEqualOfSixCards);
        Assert.AreEqual(expected, actual);
    }
    ...
    public void TestOnHandWithTwoEqualOfSixCardsOnEqualSuit()
    {
        ...
        var expected = false;
        var actual = sut.IsTwoPair(handWithTwoEqualOfSixCardsOnEqualSuit);
        Assert.AreEqual(expected, actual);
    }
